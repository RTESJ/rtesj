...
public class BackingStoreConstraint
  extends ResourceConstraint<BackingStoreConstraint>
{
  /**
   ...
   */
  public static BackingStoreConstraint getRootConstraint() { return null; }
   ...
   */
  public static BackingStoreConstraint currentConstraint() { return null; }
   ...
   * @return the constraint for this context.
   */
  public static BackingStoreConstraint currentConstraint(Thread thread)
  {
    return null;
  }

  /**
   * Determine the backing store constraint for the give execution context.
   *
   * @param group The given execution context.
   * @return the constraint for this context.
   */
  public static BackingStoreConstraint currentConstraint(ThreadGroup group)
  {
    return null;
  }
   ...
   */
  public BackingStoreConstraint(RealtimeThreadGroup group, long limit)
  {
    super(group);
  }
