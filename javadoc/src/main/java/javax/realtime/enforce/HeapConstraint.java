...
public class HeapConstraint extends ResourceConstraint<HeapConstraint>
{
   ...
   */
  public static HeapConstraint getRootConstraint() { return null; }
   ...
   */
  public static HeapConstraint currentConstraint() { return null; }
   ...
   * @return the constraint for this context.
   */
  public static HeapConstraint currentConstraint(Thread thread)
  {
    return null;
  }

  /**
   * Determine the heap constraint for the give execution context.
   *
   * @param group The given execution context.
   * @return the constraint for this context.
   */
  public static HeapConstraint currentConstraint(ThreadGroup group)
  {
    return null;
  }
   ...
   */
  public HeapConstraint(RealtimeThreadGroup group, long limit)
  {
    super(group);
  }
