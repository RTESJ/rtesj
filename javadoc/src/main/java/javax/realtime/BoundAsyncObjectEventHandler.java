 ...
 * {@link AsyncObjectEventHandler} that is permanently bound to a dedicated
 * {@link RealtimeThread}. Bound asynchronous object event handlers are for use
 * in situations where the added timeliness is worth the overhead of
...
public class BoundAsyncObjectEventHandler<P>
  extends AsyncObjectEventHandler<P>
  implements BoundSchedulable
{

  /**
   * Creates an instance of {@code BoundAsyncObjectEventHandler} which specifies
   * all possible parameters.
   * The newly-created handler inherits the
   * affinity of its creator. The Affinity of the newly-created handler will be
   * set as follow:
   * <ul>
   * <li>When defined, from SchedulingParameters.</li>
   * <li>When the creating task is in the RealtimeThreadGroup in parameters,
   * or when no group are defined, the Affinity will be inherited from the creating Thread</li>
   * <li>Otherwise, the Affinity will be inherited from the RealtimeThreadGroup
   * in parameters.  When it is not set, it will take the affinity of the group of the creating thread.</li>
   * </ul>
   *
   ...
   * @param logic The {@code Consumer} object whose {@code accept()} method
   *        is executed by {@link AsyncObjectEventHandler#handleAsyncEvent}.
   *        When {@code null}, the default {@code handleAsyncEvent} method
   *        invokes nothing.
   ...
   *         {@code logic}.
   */
  public BoundAsyncObjectEventHandler(SchedulingParameters scheduling,
  ...
  /**
   * Creates an instance of {@code BoundAsyncObjectEventHandler}.
   * This constructor is equivalent to
   * {@code BoundAsyncObjectEventHandler(scheduling, release, null, null, null, null, logic)}
   */
  public BoundAsyncObjectEventHandler(SchedulingParameters scheduling,
                                      ReleaseParameters<?> release,
                                      Consumer<P> logic)
   ...
   *  {@code BoundAsyncObjectEventHandler(scheduling, release, null, null, null, null, null)}
   */
   public BoundAsyncObjectEventHandler(SchedulingParameters scheduling,
                                      ReleaseParameters<?> release)
  {
    ...
    * Creates an instance of {@code BoundAsyncObjectEventHandler}.
    * Calling this constructor is equivalent to calling
    *  {@code BoundAsyncObjectEventHandler(null, null, null, null, null, null, logic)}
    */
  public BoundAsyncObjectEventHandler(Consumer<P> logic)
  {
    this(null, null, null, null, null, null, logic);
  }

  /**
   * Creates an instance of {@code BoundAsyncObjectEventHandler} using
   * default values.  This constructor is equivalent to
   * {@code BoundAsyncObjectEventHandler(null, null, null, null, null, null, null)}
   */
  public BoundAsyncObjectEventHandler()
  {
